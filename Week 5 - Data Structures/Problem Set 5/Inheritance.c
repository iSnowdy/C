...
{
    char alleles[2]; // Array with 2 alleles represented with chars
...
person *create_family(int generations)
{
    ...
    if (generations > 1) // The case has parents
    {
        ...
        newPerson->alleles[0] =
            newPerson->parents[0]
                ->alleles[rand() % 2]; // Modulus of any number is 0 or 1 depending on the remainder
